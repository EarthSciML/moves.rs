...
This page documents the unified MOVES Parquet output layout. It is the canonical writer-side schema for every `moves.rs` run; both onroad and nonroad emissions converge here.
...
deterministic order when byte-identity matters (fixture diffs).
