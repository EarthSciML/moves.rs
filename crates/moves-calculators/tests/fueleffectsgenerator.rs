//! Regression baseline for the Fuel Effects Generator.
//!
...
//! and the data plane they read from are out of scope for this
//! port (see the `fueleffectsgenerator` module docs); end-to-end
//! validation against canonical-MOVES captures is.
