...
//! exercise the Phase 3 generators this harness validates; the other
...
mod tests {
    ...
    fn no_nonroad_fixtures_in_the_onroad_catalogue() {
        // The `nr-*` fixtures belong to the Task 115 NONROAD gate.
        assert!(
    ...
    fn loaded_fixtures_expose_parsed_run_dimensions() {
        ...
        // Every Phase 0 fixture is authored with a <description> CDATA block.
