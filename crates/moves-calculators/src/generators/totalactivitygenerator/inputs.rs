...
//! the data-plane contract — a future (`DataFrameStore`) wiring will
...
//! are omitted, exactly as `SourceBinDistributionGenerator` port
...
///
/// This is the data-plane contract: a future (`DataFrameStore`)
...
pub struct TotalActivityInputs {
 ...
 /// Zone being analysed (`MasterLoopContext.iterLocation.zoneRecordID`) /// the zone whose `SHOAllocFactor` weights step-180 hotelling hours.
    pub zone_id: i32,
