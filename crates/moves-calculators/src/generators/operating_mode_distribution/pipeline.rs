...
/// schedule fraction and sums over driving cycles, giving `OpModeFraction2`/// the operating-mode fraction per `(sourceType, roadType, hourDay, polProcess,
