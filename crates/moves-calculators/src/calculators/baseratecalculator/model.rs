...
///
/// The Go declares three identically-shaped key structs —
/// `ExtendedIdleFractionKey`, `APUFractionKey`, `ShorepowerFractionKey`,
...
///
/// The Go declares two identically-shaped key structs —
/// `EmissionRateAdjustmentKey` and `EVEfficiencyKey`, each
