...
/// One row inserted into `##ActivityTable##` (`MOVESWorkerActivityOutput`)/// the activity record the calculator emits for one
...
/// classification code — so the column is omitted here; the output
