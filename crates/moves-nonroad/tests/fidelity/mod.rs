...
//!
//! The work item: *run every NONROAD fixture through the Rust
...
//! | [`fixtures`] | The ten `nr-*.xml` fixtures |
...
//! 3. **Pins the fixture catalogue** — it confirms all ten
...
//!
//! () consumes the [`divergence::DivergenceReport`]
...
/// `dbgemit` baselines — one `<fixture>.tsv` per NONROAD
