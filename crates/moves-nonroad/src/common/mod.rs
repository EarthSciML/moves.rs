...
//!
//! owns the design that splits state across the typed
//! sub-structs (one per include file is the starting heuristic);
//! ports the parameter and chemistry constants from
...
/// # Construction
///
/// The production path constructs this from a parsed `.opt`
