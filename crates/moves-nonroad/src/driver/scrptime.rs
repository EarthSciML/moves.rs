...
//! surfaces in the fidelity gate. In practice production
...
/// - `activity_hours_per_year`: annual activity hours (`acthpy`)/// the `acttmp` value [`crate::population::modyr::model_year`]
