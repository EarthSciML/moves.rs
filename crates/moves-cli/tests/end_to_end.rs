//! End-to-end tests for the `moves` CLI ().
//!
//! The headline test — `run_sample_runspec_walks_the_graph` — is the
...
//!
//! note: all 33 fixtures still report 0 modules executed because the
...
fn run_sample_runspec_walks_the_graph_and_writes_shaped_output() {
    ...
    let opts = RunOptions {
        ...
        calculator_dag: None, // the embedded DAG
