...
//! the plan ("CLI taking TOML/CSV input"). Default AVFT data is
...
//! and means upstream tooling (the `InputDataManager`, the CDB
//! importer in) is free to derive the defaults whichever way it
//! likes.
//!
...
//! ```
//!
//! See `moves-rust-.md`. The accompanying control
//! strategy consumes the Parquet output emitted here.
//!
